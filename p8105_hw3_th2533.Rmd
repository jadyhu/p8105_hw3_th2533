...
From the hex plot, we can see most observations are around the center of the distribution. There are som variabilities. Maximum temperature and minimum temperature has a linear relationship. Higher minimun temperature corresponds to a higher maximum temperature. This makes sense. 
